  ...
  c.fn.t = function (l, I) {
    return this.each(function () {
      var a = I,
        ...
        D = -1,
        y =
          '12qwertyuiop[]asdfghjkl;zxcvbnm,./~!@#$%^&*()_+:1234567890-=op'.split(
            []
          ),
        e = function (a, b) {
        ...
        z = function (b) {
          D != b &&
            a.blink &&
            (a.blink_perm || q.data('blinking', (D = b ? 1 : 0)))
        },
        f = {
          c: 0,
          beep: function () {
      ...
      if ('beep' == k && !b.data().is_typing && c('html').data().__TAC)
        return f.beep(), this
      if ('speed' == k && e(a) && 9 < a)
        return (
          b.data('speed', a).data('blink', Math.max(100, a + b.data().ssbs)),
          this
        )
      '' === k && (k = '<del>*</del>')
      if (b.data().is_typing)
          ...
          a.blink &&
            ...
            b.data(
              ...
              setInterval(function () {
                ...
                ++B >= q.data().blink / 10 &&
                  ((B = 0),
                  (q.data().blinking | (v = 'h' == w.css('visibility')[0]) ||
                    a.blink_perm) &&
                    w.css({ visibility: v ? 'visible' : 'hidden' }))
              }, 10)
            ))
        a.blink ||
          (b.data().bi && clearInterval(b.data().bi) && b.removeData('bi'))
      ...
      ;/<kbd.*?>/i.test((g = String(r || g))) &&
        b.parent().data('kbd', (j_ = 1)) &&
        b
          .parent()
          .data(
            'mistype',
            b.parent().data('mistype')
              ? (_j = b.parent().data().mistype)
              : (_j = 10)
          ) &&
        (a.mistype = _j) &&
        (a.kbd = j_ ? j_ : !1)
      g = g
        ...
        .replace(/<del(.*?)>([\s\S]*?)<\/del>/g, function (a, b, c, d) {
          m =
            (m = c.match(/<s>\s*(.*?)\s*<\/s>/i)) && m[0]
              ? ' data-s="' + (m[1] || '1') + '"'
              : ''
          t =
            (t = c.match(/data-ins="(.*?)"/)) && t[1]
              ? t[1]
              : '' == m
              ? 0.25
              : 0.75
      ...
      q.data(
        ...
        (H = setInterval(function () {
          n = q
          if (++A >= n.data('speed') / 10)
            if (((A = 0), n.data('paused'))) x = 1
            else if (!p) {
              p = !p
              if (e(d)) {
                if (0 < --d) {
                  p = !p
                  z(0.25 >= b.data().ins ? 0 : 1 == x ? (x = -1) : 1)
                  return
                }
              ...
              ;(d = g.shift())
                ? (((a.mistype && !a.kbd) ||
                    ...
                    -1 < (__ = c.inArray(d.toLowerCase(), y, 2)) &&
                    ((__ += ~~(2 * Math.random()) + 1),
                    ~~(2 * Math.random()) && (__ -= 3),
                    (g = c.merge(
                      [
                        90 > d.charCodeAt(0) ? y[__].toUpperCase() : y[__],
                        '</del>',
                        d
                      ],
                      g
                  ...
                  d &&
                    '/' == d[1] &&
                    b.data().ins &&
                    (d = ~~((1e3 * Number(b.data().ins)) / n.data().speed)),
                  (p = !p))
                : (clearInterval(H),
                  n.removeData(['is_typing', 'paused', 'ti']),
                  e(a.repeat) && --a.repeat,
                  -1 < a.repeat
                    ? ((a.init = !1), n.t(e(k, 'o') ? a : k, a))
                    : (z(1), e(a.fin, 'f') && a.fin(n)))
            }
        }, 10))
      )
    })
  ...
  c.fn.p = function (l) {
    return this.each(function () {
      c(this).data().is_typing &&
        c(this).t('pause', l ? (!1 === l || !0 === l ? l : void 0) : void 0)
    })
  }
  c.fn.b = function (l) {
    return this.each(function () {
